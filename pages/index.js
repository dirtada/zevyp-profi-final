              ...
              <article className="group relative flex flex-col h-full rounded-2xl bg-white ring-1 ring-black/5 p-6 shadow-sm hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 overflow-hidden cursor-default">
                ...
                <div className="flex-grow relative z-10">
                  <div className="flex items-center gap-3 mb-2">
                    <div className="w-10 h-10 rounded-full bg-[#2f3237] flex items-center justify-center text-[#f9c600] font-bold text-lg shadow-sm">6</div>
                    <h3 className="text-lg font-bold text-[#2f3237]">Zimní údržba</h3>
                  </div>
                  <p className="mt-2 text-sm text-gray-600 leading-relaxed pl-1 italic">Kompletní servis v zimním období:</p>
                  <ul className="mt-2 text-xs text-gray-600 space-y-1 pl-1">
                    <li className="flex items-center gap-2">❄️ Odklízení sněhu (parkoviště, areály)</li>
                    <li className="flex items-center gap-2">❄️ Údržba chodníků a příjezdových cest</li>
                    <li className="flex items-center gap-2">❄️ Posyp proti námraze</li>
                    <li className="flex items-center gap-2">❄️ Ruční i strojní práce</li>
                  </ul>
                </div>
              </article>
            </div>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-start justify-center">
              ...
              <div className="bg-gray-50 rounded-xl shadow-lg p-6 hover:shadow-xl transition">
                <Image src="/images/valec.png" alt="Válec Ammann AV 32" width={300} height={200} className="mx-auto" />
                <h3 className="text-xl font-bold mt-4 text-[#2f3237]">Ammann AV 32</h3>
                <ul className="text-sm text-gray-700 mt-3 space-y-2 text-left">
                  ...
                  <li className="flex items-center gap-2"><WrenchScrewdriverIcon className="w-5 h-5 text-yellow-500" /> Hutnění a zimní pluhování</li>
                </ul>
              </div>
                ...
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200">
                  <table className="w-full">
                    ...
                    <tbody className="divide-y divide-gray-100">
                      {[{ name: "Bagr s obsluhou", price: "dle domluvy" }, { name: "Zimní údržba / odklízení", price: "dle domluvy" }, { name: "Doprava stroje", price: "dle domluvy" }, { name: "Terénní úpravy", price: "dle domluvy" }, { name: "Odvoz a likvidace zeminy", price: "dle domluvy" }].map((item) => (
                  ...
                  <div className="relative w-full max-w-[340px] md:max-w-[500px] aspect-[1.7/1] bg-[#f9c600] rounded-xl shadow-2xl overflow-visible border-2 border-yellow-400" style={{ transform: 'perspective(1000px) rotateY(-20deg) rotateX(10deg) rotateZ(-3deg)', transformStyle: 'preserve-3d', boxShadow: '-20px 20px 60px rgba(0,0,0,0.3)' }}>
                    ...
                    <div className="relative z-20 h-full p-4 md:p-6 flex flex-col justify-between">
                      <div className="flex flex-col space-y-2 md:space-y-4">
                        <div className="flex items-center gap-2 md:gap-4"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-5 h-5 md:w-8 md:h-8 text-black"><path strokeLinecap="round" strokeLinejoin="round" d="M3 13h18M5 13v-3a7 7 0 0114 0v3M12 13v-8m-2 0h4" /><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l-1 4h16l-1-4" /></svg><h3 className="text-lg md:text-2xl font-extrabold uppercase text-black tracking-tight">KLÁRA PUDILOVÁ</h3></div>
                      ...
                      <div className="mt-1 pt-2 border-t-0 border-black/20 text-center"><p className="text-[9px] md:text-[11px] font-bold text-black uppercase tracking-widest">VÝKOPOVÉ PRÁCE • TERÉNNÍ ÚPRAVY • ZIMNÍ ÚDRŽBA</p></div>
                    </div>
              ...
              <form onSubmit={(e) => { e.preventDefault(); odeslat(); }} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input type="email" required className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#f9c600] focus:border-transparent transition-all" placeholder="např. jan@novak.cz" />
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input type="tel" required className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#f9c600] focus:border-transparent transition-all" placeholder="+420 123 456 789" />
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <div className="relative flex-1">
                      ...
                      <input type="text" required className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#f9c600] focus:border-transparent transition-all" placeholder="Ulice, Město" value={adresa} onChange={(e) => setAdresa(e.target.value)} />
                    </div>
                    <button type="button" onClick={spocitatVzdalenost} disabled={loadingKm} className="bg-gray-800 text-white px-5 py-2 rounded-lg font-semibold hover:bg-black transition disabled:opacity-50 whitespace-nowrap">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                   ...
                   <div className="flex flex-col h-full">
                     ...
                     <textarea required className="w-full flex-grow p-4 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#f9c600] focus:border-transparent resize-none transition-all" value={popisZK} onChange={(e) => setpopisZK(e.target.value)} placeholder={`Co potřebujete vykopat, upravit nebo odklidit?\n\nNapř.: Výkop rýhy pro vodu, nebo zimní údržba areálu.`}></textarea>
                   </div>
                </div>

                <button type="submit" disabled={sending} className={`w-full bg-[#f9c600] text-[#2f3237] text-lg font-black uppercase tracking-widest py-4 rounded-lg shadow-lg hover:bg-yellow-400 hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 ${sending ? "opacity-60 cursor-not-allowed" : ""}`}>

  ...
  <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between">
    ...
    <div className="md:w-1/2 flex justify-center">
      ...
      <section id="sluzby" className="bg-[#f9c600] text-black px-6 py-12">
        <h3 className="text-2xl md:text-3xl font-bold mb-6 text-left px-6 md:px-[28rem] text-[#1e1e1e] drop-shadow">NAŠE SLUŽBY</h3>
      ...
      <section id="technika" className="bg-white text-black px-6 py-12">
        <h3 className="text-2xl md:text-3xl font-bold mb-6 text-left px-6 md:px-[28rem] text-[#1e1e1e] drop-shadow">TECHNIKA</h3>
      ...
      <section id="cenik" className="bg-[#f9c600] text-black px-6 py-12 text-center">
        <h3 className="text-2xl md:text-3xl font-bold mb-6 text-left px-6 md:px-[28rem] text-[#1e1e1e] drop-shadow">CENÍK</h3>
      ...
      <section id="kontakt" className="bg-black text-white px-6 py-12">
        <h3 className="text-2xl md:text-3xl font-bold mb-6 text-left px-6 md:px-[28rem] text-[#1e1e1e] drop-shadow">KONTAKT</h3>
